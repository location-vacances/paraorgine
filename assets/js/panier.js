      ...
      <div class="cart-summary">
        ...
        <div style="padding:8px 0;">
          <div style="display:flex;gap:8px;">
            <input type="text" placeholder="Code promo" class="form-input" style="flex:1;padding:10px 14px;">
            <button class="btn btn-outline btn-sm" onclick="showToast('Code ORIGINE15 appliqué ✓','success')">OK</button>
          </div>
        </div>
